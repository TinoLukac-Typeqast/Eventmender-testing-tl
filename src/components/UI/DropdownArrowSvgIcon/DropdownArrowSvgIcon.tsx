import "./DropdownArrowSvgIcon.scss";

interface IDropdownArrowSvgIcon {
...
const DropdownArrowSvgIcon = ({
  ...
  <svg
    ...
    className={`dropdown-arrow ${isDropdownOpen ? "dropdown-arrow__open" : ""}`}
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      fill={fill === "none" ? "#030D45" : fill}
    />
  </svg>
);

export default DropdownArrowSvgIcon;
